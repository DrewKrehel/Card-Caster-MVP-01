...
ActiveRecord::Schema[8.0].define(version: 2026_01_15_182346) do
  ...
  create_table "playing_cards", force: :cascade do |t|
    ...
    t.index ["session_id", "zone_name", "position"], name: "index_playing_cards_on_session_id_and_zone_name_and_position"
    t.index ["session_id"], name: "index_playing_cards_on_session_id"
  end
  ...
  create_table "sessions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["owner_id"], name: "index_sessions_on_owner_id"
  ...
  add_foreign_key "playing_cards", "sessions"
